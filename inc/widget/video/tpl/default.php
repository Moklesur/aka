 <div class="themetim-editor <?php echo $instance['heading_alignment']; ?>">
	<?php if ( ! empty( $instance['icon'] ) ) :
		...
		echo  '<a href="#" data-toggle="modal" data-target="#request-a-quote">'.siteorigin_widget_get_icon( $instance['icon'], $icon_styles ).'</a>';
		?></div><?php
	endif; ?>
	<div class="<?php echo $instance['heading_alignment']; ?>-heading margin-bottom-30">
        ...
        <?php if ( ! empty( $instance['sub_title'] ) ) : ?>
            <h3 class="widget-sub-heading margin-bottom-30 margin-top-30"><?php echo esc_html( $instance['sub_title'] ); ?></h3>
        <?php endif; ?>
	</div>
 ...
 <!-- Modal -->
 <div class="modal fade" id="request-a-quote" tabindex="-1" role="dialog" aria-labelledby="request-a-quote">
	 <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><i class="fa fa-times"></i></span></button>
	 <div class="modal-dialog modal-lg" role="document">
		 <div class="modal-content">
			 <div class="modal-body">
				 <iframe class="full-width" height="415" src="<?php echo $instance['video_url']; ?>" frameborder="0" allowfullscreen></iframe>
			 </div>
		 </div>
	 </div>
 </div>

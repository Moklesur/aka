...
function themetim_typography_color($color) {
    ...
    $link_hover_color = get_theme_mod( 'link_hover_color', 'rgb(40, 169, 0)' );
     ...
     * Default Button
     */
    $btn_default_bg = get_theme_mod( 'btn_default_bg', 'rgb(40, 169, 0)' );
    $btn_default_text = get_theme_mod( 'btn_default_text', '#fff' );
    $btn_default_border = get_theme_mod( 'btn_default_border', 'rgb(40, 169, 0)' );
     ...
     * Primary Button
     */
    $btn_primary_bg = get_theme_mod( 'btn_primary_bg', 'rgb(40, 169, 0)' );
    $btn_primary_text = get_theme_mod( 'btn_primary_text', '#fff' );
    $btn_primary_border = get_theme_mod( 'btn_primary_border', 'rgb(40, 169, 0)' );
     ...
     * Success Button
     */
    $btn_success_bg = get_theme_mod( 'btn_success_bg', 'rgb(40, 169, 0)' );
    $btn_success_text = get_theme_mod( 'btn_success_text', '#fff' );
    $btn_success_border = get_theme_mod( 'btn_success_border', 'rgb(40, 169, 0)' );
    ...
    $btn_success_bg_hover = get_theme_mod( 'btn_success_bg_hover', 'rgb(40, 169, 0)' );
    $btn_success_text_hover = get_theme_mod( 'btn_success_text_hover', '#fff' );
    $btn_success_border_hover = get_theme_mod( 'btn_success_border_hover', 'rgb(40, 169, 0)' );
